...
<style type="text/css" media="screen">@import "<?php echo $this->getStyleSheet('home.css')?>";</style>


<!--

this layout uses a seperate css file (see above) because Home styles can sometimes become quite extensive
